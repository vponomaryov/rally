...
class ValidatorsTestCase(test.TestCase):
    ...
    def test_verify_share_proto_valid(self, share_proto):
        validator = self._unwrap_validator(validation.verify_share_proto)
        result = validator(
    ...
    def test_verify_share_proto_invalid(self, config):
        validator = self._unwrap_validator(validation.verify_share_proto)
