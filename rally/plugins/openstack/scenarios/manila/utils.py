...
MANILA_BENCHMARK_OPTS = [
    cfg.FloatOpt(
        ...
        default=2.0,
        help="Time to sleep in seconds after creating a resource before "
             "polling for its status."),
    cfg.FloatOpt(
        "manila_share_create_timeout",
        default=300.0,
        help="Time to wait in seconds for manila share to be created."),
    cfg.FloatOpt(
        "manila_share_create_poll_interval",
        default=3.0,
        help="Interval between checks when waiting for share creation."),
    cfg.FloatOpt(
        "manila_share_delete_timeout",
        default=180.0,
        help="Time to wait for manila share to be deleted."),
    cfg.FloatOpt(
        "manila_share_delete_poll_interval",
        default=2.0,
        help="Interval between checks when waiting for share deletion."),
]
...
class ManilaScenario(base.Scenario):
    ...
    def _create_share(self, share_proto, size=1, **kwargs):
        ...
        :param size: int -- size of a share in GB
    ...
    def _create_share_network(self, neutron_net_id=None,
        ...
        :param name: text text -- share network name
        :param description: text -- share network description
    ...
    def _delete_share_network(self, share_network):
        ...
        :param security_service: instance of :class:`ShareNetwork`.
        """
    ...
    def _list_share_networks(self, detailed=True, search_opts=None):
        ...
        :param detailed: bool -- defines either to return detailed list of
            objects or not.
        :param search_opts: dict -- container of search opts such as
            "project_id" and "name".
        :returns: list of :class:`ShareNetwork`
        """
    ...
    def _list_share_servers(self, search_opts=None):
        ...
        :param search_opts: dict -- set of key-value pairs to filter
            share servers by.
    ...
    def _create_security_service(self, type, dns_ip=None, server=None,
        ...
        :param type: text -- security service type, permitted values are
